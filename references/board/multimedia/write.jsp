		...
		<dl>
			...
			<dd class="fileChk">
				<div class="fileLayer">
					...
					<input type="checkbox" id="thumbFile0" name="thumbChk[]" data-input="thumb" class="fileCheckbox" value="Y"<c:if test="${boardFile.file.thumbAt eq 'Y'}"> checked</c:if>>
				...
				<c:if test="${not empty boardFile.fileList && fn:length(boardFile.fileList) > 0}">
					...
					<div class="fileLayer siiru-mt10">
						...
						<input type="checkbox" id="thumbFile${(status.index+1)}" name="thumbChk[]" data-input="thumb" class="fileCheckbox" value="Y"<c:if test="${file.thumbAt eq 'Y'}"> checked</c:if>>
						<label for="thumbFile${(status.index+1)}">썸네일로사용</label>
...
function board() {
	...
	$('.fileAdd').click(function() {
		...
		fileForm+= '<input type="checkbox" id="thumbFile'+(fileLength)+'" name="thumbChk[]" data-input="thumb" class="fileCheckbox" value="Y">';
		fileForm+= '<label for="thumbFile'+(fileLength)+'"> 썸네일로사용</label>';
